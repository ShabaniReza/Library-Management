...
class TestPutAuthor:
    ...
    def test_if_user_is_not_admin_returns_403(self, authenticate, put_author):
        author = baker.make(Author)
        authenticate()
...
class TestDeleteAuthor:
    def test_if_user_is_anonymous_returns_401(self, delete_author):
        author = baker.make(Author)
    ...
    def test_if_user_is_admin_returns_204(self, authenticate, delete_author):
        author = baker.make(Author)
        authenticate(True)
